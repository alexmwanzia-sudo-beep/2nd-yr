document.getElementById('carForm').addEventListener('submit', async function(event) {
    ...
    const requiredFields = [
        "userId", "make", "model", "year", "image", "numberplate", "condition", "mileage", 
    ...
    formData.append("userId", document.getElementById("userId").value); // Append the userId from the input field
    ...
    // Add owner-related fields directly as separate fields
